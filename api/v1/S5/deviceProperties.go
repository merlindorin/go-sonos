...
func (d DevicePropertiesService) SetZoneAttributes(ctx context.Context, desiredZoneName ZoneName, desiredIcon Icon, desiredConfiguration Configuration) error {
