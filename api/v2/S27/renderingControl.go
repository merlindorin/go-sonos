...
func (r RenderingControlService) SetRoomCalibrationX(ctx context.Context, calibrationId RoomCalibrationID, coefficients RoomCalibrationCoefficients, calibrationMode RoomCalibrationCalibrationMode) error {
	type SetRoomCalibrationXReq struct {
		InstanceID      InstanceID
		CalibrationID   RoomCalibrationID
		Coefficients    RoomCalibrationCoefficients
		CalibrationMode RoomCalibrationCalibrationMode
	}

	type SetRoomCalibrationXNode struct {
		Xmlns string `xml:"xmlns:u,attr"`
		SetRoomCalibrationXReq
	}

	type SetRoomCalibrationXBody struct {
		XMLName                 xml.Name                `xml:"s:Body"`
		SetRoomCalibrationXNode SetRoomCalibrationXNode `xml:"u:SetRoomCalibrationX,omitempty"`
	}

	body := SetRoomCalibrationXBody{SetRoomCalibrationXNode: SetRoomCalibrationXNode{
		SetRoomCalibrationXReq: SetRoomCalibrationXReq{
	...
	return r.doer.Do(
		ctx, opts.WithSonosUPnPOptions(controlRenderingControlService, namespaceRenderingControlService, "SetRoomCalibrationX", body, nil)...)
}
